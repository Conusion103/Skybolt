...
`;
  ...
  // Image to background in the body
  $body.style.background =
    "linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.4)), url('../img/image.png') center/cover no-repeat ";
  $body.classList.add(
    "bg-cover",
    "bg-center",
    "bg-no-repeat",
  ...
  // Remove the gradiend in small views
